...
*/
// updates for STM32F3Discovery Board Classpert -BEH
...
//this one is not part of the ST7735 driver but is added for the Adafruit board backlight. GPIO for starters; could be PWM'D
#define ST7735_LITE_Pin		    GPIO_PIN_4
#define ST7735_LITE_GPIO_Port	GPIOA
